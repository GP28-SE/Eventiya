...
export default function Register() {
    ...
    return (
        <div className="flex-grow flex min-h-screen">
            ...
            <div
                className="mt-16 hidden lg:flex lg:w-1/2 relative overflow-hidden border-r border-white/5"
                style={{
            ...
            >
                ...
                <div className="absolute inset-0 bg-[#0a0f1c]/55 z-0"></div>
                {/* Bottom fade */}
                <div className="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-[#0a0f1c] to-transparent z-10"></div>
            ...
            {/* Right Form Panel */}
            <div className="mt-20 w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative overflow-y-auto">
